...
public class Functiona56_allocation extends ExternalFunction {
    ...
    public void execute(Stack stack) {
        ...
        if (stackSize == 2) {
            ...
            if (DEBUG) {
                LOGGER.atInfo().setMessage("*************A56_Allocation call**************").log();
                LOGGER.atInfo().setMessage("result = " + result).log();
            }
            ...
            if (DEBUG) {
                LOGGER.atInfo().setMessage("*************A56_Allocation call**************").log();
                LOGGER.atInfo().setMessage("calc = " + calc).log();
                LOGGER.atInfo().setMessage("contractor = " + contractor).log();
                LOGGER.atInfo().setMessage("spill = " + spill).log();
                LOGGER.atInfo().setMessage("ta_1 = " + ta_1).log();
                LOGGER.atInfo().setMessage("req_1 = " + req_1).log();
                LOGGER.atInfo().setMessage("ta_2 = " + ta_2).log();
                LOGGER.atInfo().setMessage("req_2 = " + req_2).log();
                LOGGER.atInfo().setMessage("ta_3 = " + ta_3).log();
                LOGGER.atInfo().setMessage("req_3 = " + req_3).log();
                LOGGER.atInfo().setMessage("ta_4 = " + ta_4).log();
                LOGGER.atInfo().setMessage("req_4 = " + req_4).log();
                LOGGER.atInfo().setMessage("ta_5 = " + ta_5).log();
                LOGGER.atInfo().setMessage("req_5 = " + req_5).log();
                LOGGER.atInfo().setMessage("ta_6 = " + ta_6).log();
                LOGGER.atInfo().setMessage("req_6 = " + req_6).log();
                LOGGER.atInfo().setMessage("ta_7 = " + ta_7).log();
                LOGGER.atInfo().setMessage("req_7 = " + req_7).log();
                LOGGER.atInfo().setMessage("ta_8 = " + ta_8).log();
                LOGGER.atInfo().setMessage("req_8 = " + req_8).log();
                LOGGER.atInfo().setMessage("ta_9 = " + ta_9).log();
                LOGGER.atInfo().setMessage("req_9 = " + req_9).log();
                LOGGER.atInfo().setMessage("ta_10 = " + ta_10).log();
                LOGGER.atInfo().setMessage("req_10 = " + req_10).log();
                LOGGER.atInfo().setMessage("ta_11 = " + ta_11).log();
                LOGGER.atInfo().setMessage("req_11 = " + req_11).log();
                LOGGER.atInfo().setMessage("ta_12 = " + ta_12).log();
                LOGGER.atInfo().setMessage("req_12 = " + req_12).log();
                LOGGER.atInfo().setMessage("ta_13 = " + ta_13).log();
                LOGGER.atInfo().setMessage("req_13 = " + req_13).log();
                LOGGER.atInfo().setMessage("ta_14 = " + ta_14).log();
                LOGGER.atInfo().setMessage("req_14 = " + req_14).log();
                LOGGER.atInfo().setMessage("ta_15 = " + ta_15).log();
                LOGGER.atInfo().setMessage("req_15 = " + req_15).log();
                LOGGER.atInfo().setMessage("ta_16 = " + ta_16).log();
                LOGGER.atInfo().setMessage("req_16 = " + req_16).log();
                LOGGER.atInfo().setMessage("ta_17 = " + ta_17).log();
                LOGGER.atInfo().setMessage("req_17 = " + req_17).log();
                LOGGER.atInfo().setMessage("ta_18 = " + ta_18).log();
                LOGGER.atInfo().setMessage("req_18 = " + req_18).log();
                LOGGER.atInfo().setMessage("ta_19 = " + ta_19).log();
                LOGGER.atInfo().setMessage("req_19 = " + req_19).log();
                LOGGER.atInfo().setMessage("ta_20 = " + ta_20).log();
                LOGGER.atInfo().setMessage("req_20 = " + req_20).log();
                LOGGER.atInfo().setMessage("ta_21 = " + ta_21).log();
                LOGGER.atInfo().setMessage("req_21 = " + req_21).log();
                LOGGER.atInfo().setMessage("ta_22 = " + ta_22).log();
                LOGGER.atInfo().setMessage("req_22 = " + req_22).log();
                LOGGER.atInfo().setMessage("ta_23 = " + ta_23).log();
                LOGGER.atInfo().setMessage("req_23 = " + req_23).log();
                LOGGER.atInfo().setMessage("ta_24 = " + ta_24).log();
                LOGGER.atInfo().setMessage("req_24 = " + req_24).log();
                LOGGER.atInfo().setMessage("ta_25 = " + ta_25).log();
                LOGGER.atInfo().setMessage("req_25 = " + req_25).log();
                LOGGER.atInfo().setMessage("ta_26 = " + ta_26).log();
                LOGGER.atInfo().setMessage("req_26 = " + req_26).log();
                LOGGER.atInfo().setMessage("ta_27 = " + ta_27).log();
                LOGGER.atInfo().setMessage("req_27 = " + req_27).log();
                LOGGER.atInfo().setMessage("ta_28 = " + ta_28).log();
                LOGGER.atInfo().setMessage("req_28 = " + req_28).log();
                LOGGER.atInfo().setMessage("ta_29 = " + ta_29).log();
                LOGGER.atInfo().setMessage("req_29 = " + req_29).log();
                System.out.println("ta_30 = " + ta_30);
                System.out.println("req_30 = " + req_30);
            }

            float result = a56_allocation(
                    calc,
                    contractor,
                    spill,
                    ta_1,
            ...
            if (tot_avail < 0.005 || tot_ta < 0.005) {
                ...
                while (tot_surp >= 0.0001 && tot_short >= 0.0001 && j <= 29) { //Check to see if allocation is complete
                    ...
                    for (i = 1; i <= 30; ++i) {
                        ...
                        if (shortage[i] > 0.00001) tot_ta += ta[i];
                    } //end for
