...
public class Functiondoestimation extends ExternalFunction {
    ...
    public float doestimation(
        ...
        float[][] rawdata = new float[][]{{I_TRNTY, I_WKYTN, I_SHSTA, I_OROVL, I_FOL, I_TRNTY_Prv1, I_WKYTN_Prv1, I_SHSTA_Prv1, I_OROVL_Prv1, I_FOL_Prv1, I_TRNTY_Prv2, I_WKYTN_Prv2, I_SHSTA_Prv2, I_OROVL_Prv2, I_FOL_Prv2}}; // Until the 15th feature
