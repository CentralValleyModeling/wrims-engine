...
public class StudyParser {
    ...
    private static final Logger logger = LoggerFactory.getLogger(StudyParser.class);
    ...
    public static StudyDataSet writeWreslData(StudyConfig sc, TempData td) {
        ...
        for (String modelName : studyDataSet.getModelList()) {
            ...
            logger.debug("thisModelDataSet.wtList : " + thisModelDataSet.wtList);
            ...
            for (String timeseriesName : ds.tsMap.keySet()) {
                if (timeseriesTimeStepMap.containsKey(timeseriesName)) {
                    ...
                    timeseriesTimeStepMap.put(timeseriesName, new ArrayList<String>(Collections.singletonList(definedTimeStep)));
                }
            }
        }
