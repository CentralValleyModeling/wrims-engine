# Legacy Model Computation Support Module
...
the newer package structure for this project (`gov.ca.water.wrims.engine`). This will require 
updating CalLite as well as the models themselves, since the models are coupled to the CalLite 
implementation. A conversion utility may be considered to provide a smooth
