...
public class ProcIncModel {
    ...
    public static void findKidMap(StudyTemp st) {
        ...
        logger.info("st.kidMap_incModel" + st.kidMap_incModel);
    ...
    public static void findAllOffSpring(StudyTemp st) {
        ...
        logger.info("st.allOffspringMap_incModel {}", st.allOffspringMap_incModel);
    }
    ...
    public static void findFileGroupOrder(StudyTemp st) {
        ...
        logger.info("st.fileGroupOrder_incModel {}", st.fileGroupOrder_incModel);
