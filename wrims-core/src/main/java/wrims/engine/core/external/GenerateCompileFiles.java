...
public class GenerateCompileFiles {
	...
	public static void generateBatchFile(){
		...
		try{
			...
			while (fvni.hasNext()){
				...
				if (setPath){
					out.println("javac -cp "+currentDirectory+"/../lib/wrims-engine.jar "+"wrims\\engine\\core\\external\\Function"+functionName+".java");
				}else{
					out.println("javac -cp . wrims\\engine\\core\\external\\Function"+functionName+".java");
				}
				out.println("javah -jni wrims.engine.core.external.Function"+functionName);
	...
	public static void generateJavaFile(String functionName){	
		String javaFileFullPath=workingDir+"wrims\\engine\\core\\external\\Function"+functionName+".java";
		...
		try{
			...
			out.println("package wrims.engine.core.external;");
			out.println();
			out.println("import java.util.*;");
			out.println();
			out.println("import wrims.engine.core.components.TimeUsage;");
			out.println();
	...
	public static void generateFiles(){
		String strDirectory =workingDir+"wrims\\engine\\core\\external\\";
