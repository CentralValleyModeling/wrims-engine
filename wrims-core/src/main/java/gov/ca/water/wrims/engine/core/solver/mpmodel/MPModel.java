...
public class MPModel implements Serializable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MPModel.class);
    ...
    public void addIntVar(String varName, double lb, double ub) {
        ...
        if (lb == 0) {
            ...
            LOGGER.atError().setMessage(" Error in MPModel.").log();
    ...
    public void createConstraint(
            ...
            LinkedHashMap<String, Double> varCoefMap,
            double lb,
            double ub
    ) {
