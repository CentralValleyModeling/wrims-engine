...
import gov.ca.water.wrims.engine.core.evaluator.PreEvaluator;
...
import gov.ca.water.wrims.engine.core.solver.Cbc0Solver;
import gov.ca.water.wrims.engine.core.solver.CbcSolver;
import gov.ca.water.wrims.engine.core.solver.Clp0Solver;
import gov.ca.water.wrims.engine.core.solver.ClpSolver;
...
public class ControllerBatch {
    ...
    public ControllerBatch(String[] args) {
        ...
        try {
            ...
            LOGGER.atInfo()
                  .setMessage("Parsing Time is " + ControlData.t_parse / 60000 + "min" + Math.round((ControlData.t_parse / 60000.0 - ControlData.t_parse / 60000) * 60) + "sec")
                  .log();
            ...
            if (StudyUtils.total_errors + Error.getTotalError() == 0 && !StudyUtils.compileOnly) {
                ...
                LOGGER.atInfo()
                      .setMessage("=================Run Time is " + runPeriod / 60000 + "min" + Math.round((runPeriod / 60000.0 - runPeriod / 60000) * 60) + "sec====")
                      .log();
                ...
                LOGGER.atInfo().setMessage("=================Run ends with errors=================").log();
            }
    ...
    public StudyDataSet parse() throws RecognitionException, IOException {
        ...
        if (Error.getTotalError() > 0) {
            ...
            LOGGER.atInfo().setMessage("Total errors in the config file: " + Error.getTotalError()).log();
            LOGGER.atInfo().setMessage("============================================").log();
    ...
    public void runModelILP(StudyDataSet sds) {
        ...
        while (VariableTimeStep.checkEndDate(
            ...
            if (ControlData.solverType == Param.SOLVER_XA && ControlData.solverName.toLowerCase().contains("xalog"))
                ...
                while (VariableTimeStep.checkEndDate(
                    ...
                    if (condition) {
                        ...
                        if (ControlData.solverType == Param.SOLVER_LPSOLVE.intValue()) {
                            ...
                            if (!ControlData.useCplexLpString)
                                ILP.closeCplexLpFile(); // prevent double-locked by both core and ilp
                        ...
                        LOGGER.atInfo().setMessage("Cycle " + cycleI + " in " + ControlData.currYear + "/" + ControlData.currMonth + "/" + ControlData.currDay + " Done. (" + model + ")").log();
                        ...
                        if (ControlData.solverType == Param.SOLVER_CBC1.intValue() || ControlData.solverType == Param.SOLVER_CBC.intValue()) {
    ...
    public void runModelXA(StudyDataSet sds) {
        ...
        new InitialXASolver();
        if (Error.getTotalError() > 0) {
            LOGGER.atInfo().setMessage("Model run exits due to error.").log();
            System.exit(1);
        }
