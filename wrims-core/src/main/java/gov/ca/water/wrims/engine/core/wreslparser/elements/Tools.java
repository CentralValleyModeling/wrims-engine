...
public class Tools {
    ...
    public static Map<String, String> readFilesFromDirAsMap(String dir) throws IOException {
    ...
    public static Map<String, ArrayList<String>> getType1MapScope(Map<String, SimulationDataSet> dataMap) {
        ...
        for (String f : dataMap.keySet()) {
            ...
            for (String i : data.incFileList) {
                if (data.incFileList_local.contains(i)) {
                    scopeList.add("local");
                } else {
                    scopeList.add("global");
                }
    ...
    public static SimulationDataSet correctDataScope_shallow(
            String f,
            SimulationDataSet ds,
            Map<String, String> fileScopeMap,
    ...
    public static SimulationDataSet correctDataScope_deep(
            String f,
            SimulationDataSet ds,
            Map<String, String> fileScopeMap,
            Map<String, Set<String>> t1ReverseMap
        ...
        if (!t1ReverseMap.containsKey(f)) return ds;
    ...
    public static Map<String, SimulationDataSet> getAllOffSprings(
            String nodeFile,
            Map<String, ArrayList<String>> t1Map,
    ...
    public static Map<String, SimulationDataSet> putDataFileMapFromWholeStudy(
            String file,
            Map<String, SimulationDataSet> fileDataMap
    ) {
    ...
    public static SimulationDataSet overwrite_set(SimulationDataSet main, SimulationDataSet s) {
        ...
        SimulationDataSet a = new SimulationDataSet();
        a.add(main);
        SimulationDataSet b = new SimulationDataSet();
        b.add(s);
    ...
    public static Set<String> restoreOrder(
            ArrayList<String> toBeRestored,
            ArrayList<String> referenceOrder,
            Set<String> member
    ) {
