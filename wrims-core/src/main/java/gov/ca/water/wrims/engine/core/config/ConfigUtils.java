...
public class ConfigUtils {
    ...
    public static void loadArgs(String[] args) {
        ...
        if (argsMap.containsKey("-config")) {
            ...
            logger.atWarn().setMessage("Config file and RUN directory must be placed in the same folder!").log();
            logger.atInfo().setMessage("Loading config file:\t{}").addArgument(argsMap.get("-config")).log();
            ...
            logger.atInfo().setMessage("Compiling main wresl file:\t{}").addArgument(argsMap.get("-mainwresl")).log();
            StudyUtils.compileOnly = true;
            FilePaths.setMainFilePaths(argsMap.get("-mainwresl"));

        } else if (argsMap.containsKey("-mainwreslplus")) {
            logger.atInfo()
                  .setMessage("Compiling main wresl+ file:\t{}")
                  .addArgument(argsMap.get("-mainwreslplus"))
                  .log();
            StudyUtils.compileOnly = true;
            ...
            logger.atError().setMessage("Example: \n-config=\"D:\\test\\example.config\"").log();
            System.exit(1);
        }
    }
    ...
    private static void logValue(String key, String value) {
        logger.atInfo().setMessage("{}: {}").addArgument(key).addArgument(value).log();
    }
    ...
    private static void loadConfig(String configFile) {
        ...
        try {
            ...
            if (!gwDir.isEmpty()) {
                if (gwDir.contains(":")) {
                    ...
                    FilePaths.groundwaterDir = new File(
                            StudyUtils.configDir,
                                                        gwDir
            ...
            if (configMap.get("svarfile").contains(":")) {
                ...
                FilePaths.setSvarFilePaths(new File(
                        StudyUtils.configDir,
                                                    configMap.get("svarfile")
                ).getCanonicalPath());
            }
            ...
            if (configMap.get("svarfile2").equals("")) {
                ...
                if (configMap.get("svarfile2").contains(":")) {
                    ...
                    FilePaths.setSvarFile2Paths(new File(
                            StudyUtils.configDir,
                                                         configMap.get("svarfile2")
                    ).getCanonicalPath());
                }
            ...
            if (configMap.get("initfile").contains(":")) {
                ...
                FilePaths.setInitFilePaths(new File(
                        StudyUtils.configDir,
                                                    configMap.get("initfile")
                ).getCanonicalPath());
            }
            ...
            if (configMap.get("dvarfile").contains(":")) {
                ...
                FilePaths.setDvarFilePaths(new File(
                        StudyUtils.configDir,
        ...
        if (configMap.get("showwresllog").equalsIgnoreCase("no") || configMap.get("showwresllog")
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("watchT: Error reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcToleranceZero: Error reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcToleranceInteger: Error reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcLowerBoundZeroCheck:  reading config value").log();
            }
        }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcToleranceIntegercheck:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcHintTimeMax:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcHintRelaxPenalty:  reading config value").log();
            }
        }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcTolerancePrimal:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcTolerancePrimalRelax:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcToleranceWarmPrimal:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcLogStartDate:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("CbcLogStopDate:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("LogIfObjDiff:  reading config value").log();
            }
        ...
        if (configMap.containsKey(k)) {
            ...
            try {
                ...
                logger.atError().setCause(e).setMessage("RecordIfObjDiff:  reading config value").log();
            }
        ...
        if (ControlData.solverName.equalsIgnoreCase("lpsolve")) {
            ...
            if (configMap.containsKey("lpsolveconfigfile")) {
                ...
                try {
                    ...
                    Error.writeErrorLog();
                    logger.atError()
                          .setMessage("Error encountered when attempting to parse LpSolveConfigFile")
                          .setCause(e)
                          .log();
                }
            } else {
        ...
        ILP.loggingUsageMemeory = strIlpLogUsageMemory.equalsIgnoreCase("yes") || strIlpLogUsageMemory.equalsIgnoreCase(
                "true");
        ...
        ControlData.isOutputCycle = outputCycleDataToDss.equalsIgnoreCase("yes") || outputCycleDataToDss.equalsIgnoreCase(
                "true");
        logValue("OutputCycleDataToDSS", ControlData.isOutputCycle);

        String outputAllCycleData = configMap.get("outputallcycledata");
        ControlData.outputAllCycles = outputAllCycleData.equalsIgnoreCase("yes") || outputAllCycleData.equalsIgnoreCase(
                "true");
        ...
        ControlData.showRunTimeMessage = showRunTimeMessage.equalsIgnoreCase("yes") || showRunTimeMessage.equalsIgnoreCase(
                "true");
        logValue("ShowRunTimeMessage", ControlData.showRunTimeMessage);

        String printGWFuncCalls = configMap.get("printgwfunccalls");
        ControlData.printGWFuncCalls = printGWFuncCalls.equalsIgnoreCase("yes") || printGWFuncCalls.equalsIgnoreCase(
                "true");
        ...
        ControlData.unchangeGWRestart = unchangeGWRestart.equalsIgnoreCase("yes") || unchangeGWRestart.equalsIgnoreCase(
                "true");
    ...
    public static double readDouble(Map<String, String> cM, String name, double defaultV) {
        ...
        if (cM.containsKey(l)) {
            ...
            try {
                ...
                logger.atError().setMessage("{}:  reading config value").addArgument(name).log();
            }
        }
        return returnV;
    }
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (isParameter) {
                    ...
                    logger.atInfo()
                          .setMessage("Initial variable:\t{}: {}")
                          .addArgument(pt.id.toLowerCase())
                          .addArgument(pt.expression)
                          .log();
