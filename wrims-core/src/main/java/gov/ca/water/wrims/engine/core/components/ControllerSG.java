...
public class ControllerSG {
    ...
    public void setControlData() {
        ...
        ControlData.svDvPartF = "CALSIM30_06";
        ControlData.initPartF = "CALSIM30_06";
        ControlData.partA = "CALSIM";
        ControlData.defaultTimeStep = "1MON";
        ControlData.startYear = 1921;
        ControlData.startMonth = 10;
        ControlData.startDay = 31;
        ControlData.endYear = 2003;
        ControlData.endMonth = 9;
        ControlData.endDay = 30;
                ...
                while (VariableTimeStep.checkEndDate(
                    ...
                    if (condition) {
                        ...
                        if (ControlData.cbc_debug_routeXA || ControlData.cbc_debug_routeCbc) {
                            ...
                            ILP.writeNoteLn(
                                    ILP.getYearMonthCycle(),
                                    "" + ControlData.xasolver.getObjective(),
                                    ILP._noteFile_xa_obj
                            );
                            ILP.writeNoteLn(
                                    ILP.getYearMonthCycle(),
                                    "" + ControlData.clp_cbc_objective,
                                    ILP._noteFile_cbc_obj
                            );
    ...
    public ControllerSG(String[] args) {
        ...
        long endTimeInMillis = Calendar.getInstance().getTimeInMillis();
        int runPeriod = (int) (endTimeInMillis - startTimeInMillis);
        LOGGER.atInfo().setMessage("=================Run Time is " + runPeriod / 60000 + "min" + Math.round((runPeriod / 60000.0 - runPeriod / 60000) * 60) + "sec====").log();
        System.exit(0);
    }
    ...
    public void setControlData(String[] args) {
        ...
        ControlData.currDay = ControlData.startDay;
        if (args.length > 17) {
            StudyUtils.useWreslPlus = args[17].equalsIgnoreCase("wreslplus");
        }
    }
