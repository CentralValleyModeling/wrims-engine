...
import gov.ca.water.wrims.engine.core.commondata.wresldata.Alias;
...
import gov.ca.water.wrims.engine.core.commondata.wresldata.Svar;
...
import gov.ca.water.wrims.engine.core.debug.ChangeSolver;
import gov.ca.water.wrims.engine.core.debug.FilterGoal;
import gov.ca.water.wrims.engine.core.debug.ReLoadSVDss;
import gov.ca.water.wrims.engine.core.evaluator.*;
...
import gov.ca.water.wrims.engine.core.solver.CloseCurrentSolver;
...
import gov.ca.water.wrims.engine.core.solver.SetXALog;
import gov.ca.water.wrims.engine.core.tools.Warmstart;
import gov.ca.water.wrims.engine.core.wreslparser.elements.FileParser;
import gov.ca.water.wrims.engine.core.wreslparser.elements.SimulationDataSet;
import gov.ca.water.wrims.engine.core.wreslparser.elements.StudyParser;
import gov.ca.water.wrims.engine.core.wreslparser.elements.StudyUtils;
import gov.ca.water.wrims.engine.core.wreslparser.grammar.WreslTreeWalker;
import gov.ca.water.wrims.engine.core.wreslplus.elements.AliasTemp;
import gov.ca.water.wrims.engine.core.wreslplus.elements.DvarTemp;
import gov.ca.water.wrims.engine.core.wreslplus.elements.GoalTemp;
import gov.ca.water.wrims.engine.core.wreslplus.elements.IfIncItemGroup;
import gov.ca.water.wrims.engine.core.wreslplus.elements.ModelTemp;
...
import gov.ca.water.wrims.engine.core.wreslplus.elements.SvarTemp;
import gov.ca.water.wrims.engine.core.wreslplus.elements.Tools;
import gov.ca.water.wrims.engine.core.wreslplus.elements.procedures.ProcIfIncItemGroup;
import gov.ca.water.wrims.engine.core.wreslplus.elements.procedures.ProcWeight;
...
public class DebugInterface {
    ...
    public DebugInterface(int requestPort, int eventPort, String[] args) {
        ...
        try {
            ...
            LOGGER.atInfo().setMessage(e.getMessage()).log();
        } finally {
            try {
                fileOut.close();
                requestIn.close();
    ...
    public void handleRequest(String request) {
        ...
        if (request.equals("start")) {
            ...
            LOGGER.atInfo().setMessage("Terminate requested").log();
            controllerDebug.requestTerminate();
            if (isDebugging) {
                LOGGER.atInfo().setMessage("Close Solvers").log();
                ...
                LOGGER.atInfo().setMessage("Save Data").log();
                try {
                    ...
                    LOGGER.atInfo().setMessage("Exception ocurred while saving data during termination").log();
                    exception.printStackTrace();
                }
                LOGGER.atInfo().setMessage("Close Dss Files").log();
                ControlData.dvDss.close();
                terminateCode = 1;
            }
            LOGGER.atInfo().setMessage("Terminated").log();
            try {
            ...
            LOGGER.atInfo().setMessage("suspended").log();
            try {
            ...
            if (requestParts[1].equals("recompile")) {
                ...
                try {
                    ...
                    if (StudyParser.total_errors == 0) {
                        ...
                        LOGGER.atInfo().setMessage("The change of your code has errors.").log();
                        sendEvent("terminate");
                    }
            ...
            if (ControlData.isOutputCycle) {
                Date resimDate = new Date(
                        ControlData.resimYear - 1900,
                                          ControlData.resimMonth - 1,
                                          ControlData.resimDay
                );
                Date cycleDataDate = new Date(
                        ControlData.cycleDataStartYear - 1900,
                                              ControlData.cycleDataStartMonth - 1,
                                              ControlData.cycleDataStartDay
                );
            ...
            LOGGER.atInfo().setMessage("Output cycle data to Dss file is turned on").log();
            ...
            LOGGER.atInfo().setMessage("Output cycle data to Dss file is turned off").log();
            ...
            LOGGER.atInfo().setMessage("All cycles are selected").log();
            ...
            if (!ControlData.outputAllCycles)
                LOGGER.atInfo().setMessage("Cycles " + ControlData.selectedCycleOutput.replace("'", "") + " are selected").log();
            ...
            if (showRunTimeMessage.equalsIgnoreCase("True")) {
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Run time messages shown").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Run time messages disabled").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
            ...
            if (printGWFuncCalls.equalsIgnoreCase("True")) {
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Print groundwater function calls on").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Print groundwater function calls off").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
            ...
            if (ilpLogUsageMemory.equalsIgnoreCase("True")) {
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Track memory usage on").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    LOGGER.atInfo().setMessage("Track memory usage off").log();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
            ...
            try {
                ...
                LOGGER.atInfo().setMessage(request + " set").log();
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        if (dvAliasTSMap.containsKey(entryName)) {
            ...
            for (int i = 0; i <= currIndex; i++) {
                ...
                if (!(value == -901.0 || value == -902.0)) {
                    ...
                    dataString = dataString + timestepListed + ":" + prvs.dataMonth + "-" + prvs.dataDay + "-" + prvs.dataYear + ":" + df.format(
                            value) + "#";
                }
            }
        } else {
    ...
    public String getFutureValueDetail(String variableName) {
        ...
        for (int i = 0; i < indexList.size(); i++) {
            ...
            dataString = dataString + index + ":" + prvs.dataMonth + "-" + prvs.dataDay + "-" + prvs.dataYear + ":" + df.format(
                    futureArray.get(index)) + "#";
        }
                ...
                for (String cycle : ml) {
                    if (cycleIndex <= ControlData.currCycleIndex + 1) {
                        if (cycleValue.containsKey(cycle)) {
                            ...
                            if (id != null)
                                dataString = dataString + cycleIndex + ":" + cycle + ":" + df.format(id.getData()) + "#";
    ...
    public String getAllVariableFiles() {
        ...
        try {
            ...
            for (String variable : allDataNames) {
                allDataBuffer.write(variable + ":" + df.format(allData.get(variable)) + System.getProperty(
                        "line.separator"));
            }
            allDataBuffer.close();
            ...
            for (int i = 0; i <= 1; i++) {
                ...
                while (weightIterator.hasNext()) {
                    ...
                    allWeightBuffer.write(weightName + ":" + df.format(weightMap.get(weightName)
                                                                                .getValue()) + System.getProperty(
                            "line.separator"));
                }
            }
            ...
            while (usedWeightSlackSurplusIterator.hasNext()) {
                String usedWeightSlackSurplusName = usedWeightSlackSurplusIterator.next();
                allWeightBuffer.write(usedWeightSlackSurplusName + ":" + df.format(weightSlackSurplusMap.get(
                        usedWeightSlackSurplusName).getValue()) + System.getProperty("line.separator"));
            }
        ...
        if (fileFullPath.equalsIgnoreCase(FilePaths.fullMainPath)) {
            ...
            for (String model : modelList) {
                ...
                for (int i = 0; i < ifIncItemGroupIDList.size(); i++) {
                    ...
                    ArrayList<Boolean> conditionValueList = ProcIfIncItemGroup.evaluateConditions(Tools.allToLowerCase(
                            ifIncItemGroup.conditionList));
                    int j = 0;
        ...
        try {
            ...
            for (int i = 0; i < gKeyArrayList.size(); i++) {
                ...
                if (ec != null) {
                    ...
                    double value1 = value.doubleValue();
                    if (value1 > 0) {
                        goalString = goalString + "+" + df.format(value) + ec.getSign() + "0" + System.getProperty(
                                "line.separator");
                    } else if (value1 < 0) {
                        goalString = goalString + df.format(value) + ec.getSign() + "0" + System.getProperty(
                                "line.separator");
    ...
    public void setSolverOptions(String[] requestParts) {
        ...
        LOGGER.atInfo().setMessage("Change solver to " + solverName).log();
        if (solverName.equals("XA")) {
            ...
            if (log.equals("None")) {
                ...
                LOGGER.atInfo().setMessage("Log file turn off").log();
                ...
                ILP.initializeIlp();
                LOGGER.atInfo().setMessage("Log file turn on").log();
            }
            ...
            if (log.equals("None")) {
                ...
                LOGGER.atInfo().setMessage("Log file turned off").log();
            } else if (log.equals("Log")) {
                ILP.logging = true;
                ILP.loggingVariableValue = true;
                ControlData.cbc_debug_routeXA = false;
                ControlData.cbc_debug_routeCbc = false;
                LOGGER.atInfo().setMessage("Log file turned on").log();
                ...
                new InitialXASolver();
                LOGGER.atInfo().setMessage("CBC route turned on").log();
                ...
                ControlData.cbc_debug_routeCbc = false;
                new InitialXASolver();
                LOGGER.atInfo().setMessage("XA route turned on").log();
            }
    ...
    public static void main(String[] args) {
        ...
        System.arraycopy(args, 2, modArgs, 0, argsSize - 3 + 1);
    ...
    public String getAllVariableString() {
        ...
        while (usedWeightSlackSurplusIterator.hasNext()) {
            String usedWeightSlackSurplusName = usedWeightSlackSurplusIterator.next();
            dataString = dataString + usedWeightSlackSurplusName + ":" + df.format(weightSlackSurplusMap.get(
                    usedWeightSlackSurplusName).getValue()) + "#";
        }
