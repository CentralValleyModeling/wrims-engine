...
public class TF {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LOGGER.atInfo().setMessage("TensorFlow version: " + TensorFlow.version()).log();
        ...
        long[] sx = input.shape();
        LOGGER.atInfo().setMessage("input shape: " + sx[0] + " " + sx[1]).log();
        ...
        result.copyTo(out);
        LOGGER.atInfo().setMessage("results: " + out[0][0]).log();
        model.close();
    }
...
package gov.ca.water.wrims.engine.core.tf;
...
public class TF {
    ...
    public static void main(String[] args) throws Exception {
        ...
        float[][] rawdata = new float[][]{{35.2f, 25.3f, 332.0f, 191.6f, 127.3f, 20.6f, 3.2f, 235.0f, 99.9f, 36.1f, 10.1f, 0.6f, 230.0f, 88.7f, 17.8f}}; // Until the 15th feature
        long[][] rawdata_int = new long[][]{{3, 2}}; // The 16th and 17th features as integers

        String[] tensorNames = new String[]{"serving_default_trinity_inflow_input:0", "serving_default_whiskeytown_inflow_input:0", "serving_default_shasta_inflow_input:0", "serving_default_oroville_inflow_input:0", "serving_default_folsom_inflow_input:0", "serving_default_trinity_inflow_1m_input:0", "serving_default_whiskeytown_inflow_1m_input:0", "serving_default_shasta_inflow_1m_input:0", "serving_default_oroville_inflow_1m_input:0", "serving_default_folsom_inflow_1m_input:0", "serving_default_trinity_inflow_2m_input:0", "serving_default_whiskeytown_inflow_2m_input:0", "serving_default_shasta_inflow_2m_input:0", "serving_default_oroville_inflow_2m_input:0", "serving_default_folsom_inflow_2m_input:0",};

        String[] tensorNames_int = new String[]{"serving_default_wy_month_input:0", "serving_default_wyt_sac_input:0"};
