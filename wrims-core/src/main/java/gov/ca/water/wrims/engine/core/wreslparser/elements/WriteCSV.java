...
public class WriteCSV {
    ...
    public static void svar(Map<String, Svar> sMap, ArrayList<String> list, PrintWriter out) {
        ...
        for (String k : keys) {
            ...
            //	SvarProps p =sMap.get(k);
            {
                ...
                boolean usedByLaterCycle = currentModelDataSet.svarUsedByLaterCycle.contains(k);
    ...
    public static void dvar(Map<String, Dvar> dMap, ArrayList<String> list, PrintWriter out) {
        ...
        for (String k : keys) {
            ...
            boolean usedByLaterCycle = currentModelDataSet.dvarUsedByLaterCycle.contains(k);
...
//		    	out.print(Param.csv_seperator+g.case_lhs_lt_rhs.get(i)); //for EXPRESSION
    ...
    public static void weight(Map<String, WeightElement> wtMap, ArrayList<String> list, PrintWriter out) {
        ...
        for (String k : keys) {
            ...
            if (!wtMap.containsKey(k)) LOGGER.atInfo().setMessage("##### not exist in wtMap:" + k).log();
    ...
    public static void alias(Map<String, Alias> asMap, ArrayList<String> list, PrintWriter out) {
        ...
        for (String k : keys) {
            ...
            boolean usedByLaterCycle = currentModelDataSet.aliasUsedByLaterCycle.contains(k);
    ...
    public static void alias_unknown(
            Map<String, Alias> asMap,
    ...
    public static void mapStringListMerged(Object obj, PrintWriter out) {
        ...
        @SuppressWarnings("unchecked") List<Map<String, List<String>>> listMapStringList = (List<Map<String, List<String>>>) obj;
