package gov.ca.water.wrims.engine.core.solver.clp;
...
public class FilePassingUtils {
    ...
    public static void main(String[] args) {
        ...
        LOGGER.atInfo().setMessage("solver message:" + solverMessage).log();
        LOGGER.atInfo().setMessage("error code:" + solverErrorCode).log();
        LOGGER.atInfo().setMessage("obj value:" + objective_value).log();

        for (String key : varDoubleMap.keySet()) {
            LOGGER.atInfo().setMessage(key + ":" + varDoubleMap.get(key)).log();
        }
