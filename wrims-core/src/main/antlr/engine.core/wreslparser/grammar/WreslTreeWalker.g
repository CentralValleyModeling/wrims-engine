...
@header {
  package wrims.engine.core.wreslparser.grammar;
  import java.util.Map;
  import java.util.HashMap;
  import wrims.engine.core.wreslparser.elements.StructTree;
  import wrims.engine.core.wreslparser.elements.SimulationDataSet;
  import wrims.engine.core.wreslparser.elements.Tools;
